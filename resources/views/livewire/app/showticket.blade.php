<div wire:ignore id="exercise_drawer_" class="drawer drawer-end" data-kt-drawer-scroll="true"  data-kt-drawer="true" data-kt-drawer-activate="true" data-kt-drawer-toggle="#exercise_button_" data-kt-drawer-close="#exercise_close_" data-kt-drawer-width="100%">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-250px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3">
                                                ...
                                                <!--end::Svg Icon-->Privacy <span class="badge badge-light-danger ms-auto">5</span>
                                            </a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
