            ...
            <div class="card mb-5 mb-xl-8">
                <div class="card-header border-0 py-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold fs-3 mb-1">Sanal Pos Entegrasyonu</span>
                        <span class="text-muted mt-1 fw-semibold fs-7">Sanal Pos Entegratörleri Bilgileri</span>
                    </h3>
                    <div class="card-toolbar border-0">
                        <button type="button" class="btn btn-sm btn-light-primary mx-4" id="new_sms_integrator_button">
                            Yeni Sanal Pos Entegratörü Ekle
                        </button>
                        <div>
                            @push('scripts')
                                        ...
                                        <div class="card-title">
                                            <div class="d-flex justify-content-center flex-column me-3">
                                                <a href="javascript:;" class="fs-4 fw-bold text-gray-900 text-hover-primary me-1 lh-1">
                                                    Yeni Sanal Pos Entegratörü Oluştur
                                                </a>
                                            </div>
                                        </div>
