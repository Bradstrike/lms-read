			...
			<div class="card card-flush h-xl-100">
				<div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px" style="background-image:url('/assets/media/svg/shapes/top-green.png" data-theme="light">
					<h3 class="card-title align-items-start flex-column text-white pt-15">
						<span class="fw-bold fs-2x mb-3">Merhaba, {{ auth()->user()->firstname }}</span>

						<div class="fs-4 text-white">
							<span class="opacity-75">Seni bekleyen</span>
							<span class="position-relative d-inline-block">
								<a href="{{ route('app.lessons') }}" class="link-white opacity-75-hover fw-bold d-block mb-1">{{ auth()->user()->lessons()->count() }} eğitim</a>
								<span class="position-absolute opacity-50 bottom-0 start-0 border-2 border-body border-bottom w-100"></span>
							</span>
							<span class="opacity-75">mevcut</span>
						</div>
					</h3>
				</div>
						...
						<div class="row g-3 g-lg-6">
							...
							<div class="col-6">
								...
								<div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
									...
									<div class="m-0">
										<!--begin::Number-->
										<span class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{ auth()->user()->lessons()->count() }}</span>
										<!--end::Number-->
										<!--begin::Desc-->
										<span class="text-gray-500 fw-semibold fs-6">Eğitim</span>
										<!--end::Desc-->
									</div>
									<!--end::Stats-->
								</div>
							...
							<div class="col-6">
								...
								<div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
									...
									<div class="m-0">
										...
										<!--end::Number-->
										<!--begin::Desc-->
										<span class="text-gray-500 fw-semibold fs-6">Sertifika</span>
										<!--end::Desc-->
									</div>
									<!--end::Stats-->
								</div>
							...
							<div class="col-6">
								...
								<div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
									...
									<div class="m-0">
										<!--begin::Number-->
										<span class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">17</span>
										<!--end::Number-->
										<!--begin::Desc-->
										<span class="text-gray-500 fw-semibold fs-6">Yapılan Egzersiz</span>
										<!--end::Desc-->
									</div>
									<!--end::Stats-->
								</div>
							...
							<div class="col-6">
								...
								<div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
									...
									<div class="m-0">
										<!--begin::Number-->
										<span class="text-gray-700 fw-bolder fs-2qx lh-1 ls-n1 mb-1">822</span> <span class="text-gray-700 fs-8">kelime/dakika</span>
										<!--end::Number-->
										<!--begin::Desc-->
										<br/>
										<span class="text-gray-500 fw-semibold fs-6">Okuma Hızı</span>
										<!--end::Desc-->
									</div>
									<!--end::Stats-->
								</div>
		...
		<div class="card card-flush h-md-100">
			...
			<div class="card-header card-header-stretch">
				...
				<div class="card-title">
					<h3 class="m-0 text-gray-900">Aktivite Özetiniz</h3>
				</div>
				<!--end::Title-->
				<!--begin::Toolbar-->
