            ...
            <div class="card card-flush h-xl-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="m-0">
                            <img src="/uploads/{{ $lesson->thumbnail }}" class="h-50px w-50px my-4 rounded"/>
                            <h4 class="fw-bold text-gray-800 mb-3">{{ $lesson->name }}</h4>
                            <p>
                                {{ $lesson->description }}
                            </p>
                            <div class="d-flex d-grid gap-5 pt-3">
                                <div class="d-flex flex-column flex-shrink-0 me-4">
                                    <span class="d-flex align-items-center fs-7 fw-bold text-gray-400 mb-2">
                                        ...
                                        {{ $lesson->lectures->count() }} Egzersiz
                                    </span>
                                </div>
                            ...
                            <a class="btn btn-primary mt-3" href="{{ url('/uygulama/egzersiz') }}"><i class="bi bi-box-arrow-in-up-right"></i> Eğitime Başla</a>
