                ...
                @foreach($tickets as $ticket)
                 <tr class="odd">
                        ...
                        <a href="#" class="d-flex align-items-center text-dark">
                            <div class="symbol symbol-35px me-3">
                                <div class="symbol-label bg-light-danger">
                                    <span class="text-danger">{{ $ticket->id }}</span>
                                </div>
                            </div>
                            <span class="fw-semibold">{{ $ticket->user->firstname }}  {{ $ticket->user->lastname }}</span>
                        </a>
                    </td>
                    <td>
                        <div class="text-dark mb-1">
                            <a href="/metronic8/demo1/../demo1/apps/inbox/reply.html" class="text-dark">
                                ...
                                <span class="d-none d-md-inine text-muted">{{$ticket->title}}</span>
                            </a>
                        </div>
                    ...
                    <td class="w-100px text-end fs-9 pe-9">
                        <span class="fw-semibold">{{ $ticket->state }}</span>
                    </td>
                    <td style="padding-left:34%;">
                        <button class="btn btn-light-success" data-bs-toggle="modal" data-bs-target="#kt_modal_scrollable_2">Cevapla</button>
                        <button type="button" data-bs-toggle="modal" data-bs-target="#kt_modal_1" id="alert" class="btn btn-light-danger">Sil</button>
                    </td>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer px-4 py-2">
                                        ...
                                        <button type="button" wire:click="delete({{ $ticket->id }})" class="btn btn-danger">Evet</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">{{ $ticket->user->firstname }} {{ $ticket->user->lastname }} Mesajı Cevaplanıyor</h5>
                                ...
                                <form id="kt_inbox_reply_form" class="rounded border mt-10">
                                    ...
                                    <div class="d-block">
                                        ...
                                        <div class="d-flex align-items-center border-bottom px-8 min-h-50px">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                           <input type="text" class="form-control border-0" name="compose_to" value="{{ $ticket->user->email }}" data-kt-inbox-form="tagify" tabindex="-1">
                                            <!--end::Input-->
                                ...
                                <div class="card">
                                    <div class="card-header align-items-center py-5 gap-5">
                                        ...
                                        <div class="d-flex">
                                            <!--begin::Back-->
                                            <a
                                                href="/metronic8/demo1/../demo1/apps/inbox/listing.html"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a
                                                ...
                                                data-bs-original-title="Previous message"
                                                data-kt-initialized="1"
                                            >
                                            ...
                                            <a
                                                ...
                                                data-bs-original-title="Next message"
                                                data-kt-initialized="1"
                                            >
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-250px py-4" data-kt-menu="true">
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="#" class="menu-link px-3">
                                                            ...
                                                            <!--end::Svg Icon-->Groups <span class="badge badge-light-primary ms-auto">new</span>
                                                        </a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="#" class="menu-link px-3">
                                                            ...
                                                            <span class="svg-icon svg-icon-3 me-3">
                                                                ...
                                                                Privacy <span class="badge badge-light-danger ms-auto">5</span>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex flex-wrap gap-2 justify-content-between mb-8">
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                <h2 class="fw-semibold me-3 my-1">Mesajınızı Sistem Yetkilisine İletin</h2>
                                            ...
                                            <div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer" data-kt-inbox-message="header">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-50 me-4">
                                                        <span class="symbol-label" style="background-image: url(/metronic8/demo1/assets/media/avatars/300-6.jpg);"></span>
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <div class="pe-5">
                                                        ...
                                                        <div class="text-muted fw-semibold mw-450px d-none" data-kt-inbox-message="preview">CONTENT</div>
                                                        <!--end::Preview message-->
                                                    </div>
                                                </div>
                                                <!--end::Author-->
                                                ...
                                                <div class="d-flex align-items-center flex-wrap gap-2">
                                                    <!--begin::Date-->
                                                    <span class="fw-semibold text-muted text-end me-3">05 May 2022, 10:10 pm</span>
                                                    <!--end::Date-->
                                                    <div class="d-flex">
                                                        <!--begin::Star-->
                                                        <a
                                                        ...
                                                        <a
                                                            ...
                                                            data-bs-original-title="Mark as important"
                                                            data-kt-initialized="1"
                                                        >
                                        ...
                                        <!--KULLANICININ MESAJI VARSA BURADA LİSTELENECEK-->
                                        ...
                                        <form id="kt_inbox_reply_form" class="rounded border mt-10">
                                            ...
                                            <div class="d-block">
                                                ...
                                                <div class="d-flex align-items-center border-bottom px-8 min-h-50px">
                                                    ...
                                                    <input type="text" class="form-control border-0" name="compose_to" value="Admin" data-kt-inbox-form="tagify" tabindex="-1" />
                                                    <!--end::Input-->
                                                    <!--begin::CC & BCC buttons-->
                                                    <div class="ms-auto w-75px text-end">
                                                        <span class="text-muted fs-bold cursor-pointer text-hover-primary me-2" data-kt-inbox-form="cc_button">Cc</span>
                                                ...
                                                <div class="d-none align-items-center border-bottom ps-8 pe-5 min-h-50px" data-kt-inbox-form="cc">
                                                    ...
                                                    <input type="text" class="form-control border-0" name="compose_cc" value="" data-kt-inbox-form="tagify" tabindex="-1" />
                                                    <!--end::Input-->
                                                    <!--begin::Close-->
                                                    <span class="btn btn-clean btn-xs btn-icon" data-kt-inbox-form="cc_close">
                                                        <i class="la la-close"></i>
                                                ...
                                                <div class="d-none align-items-center border-bottom inbox-to-bcc ps-8 pe-5 min-h-50px" data-kt-inbox-form="bcc">
                                                    ...
                                                    <input type="text" class="form-control border-0" name="compose_bcc" value="" data-kt-inbox-form="tagify" tabindex="-1" />
                                                    <!--end::Input-->
                                                    <!--begin::Close-->
                                                    <span class="btn btn-clean btn-xs btn-icon" data-kt-inbox-form="bcc_close">
                                                        <i class="la la-close"></i>
