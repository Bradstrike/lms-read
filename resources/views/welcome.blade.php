...
<html lang="en">
    <!--begin::Head-->
    <head><base href="">
        <title>HOHA - HIZLI OKUDUĞUNU HIZLI ANLAMA</title>
        <meta charset="utf-8" />
                ...
                <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                    ...
                    <div id="kt_header" class="header">
                        ...
                        <div class="container-fluid d-flex align-items-center flex-wrap justify-content-between" id="kt_header_container">
                            ...
                            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-2 pb-5 pb-lg-0 pt-7 pt-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                                <!--begin::Heading-->
                                <h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">Mobil Brain
                                <small class="text-muted fs-6 fw-semibold ms-1 pt-1">KLYNAPPS</small></h1>
                                <!--end::Heading-->
                            </div>
                            <!--end::Page title=-->
                            <!--begin::Wrapper-->
                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="container-fluid" id="kt_content_container">
                            <a class="btn btn-outline btn-outline-dashed btn-outline-primary btn-active-light-primary" href="{{ route('app.dashboard') }}"><i class="las la-sign-in-alt"></i> Giriş Yap</a>
                        </div>
                        <!--end::Container-->
                    </div>
                    <!--end::Content-->
