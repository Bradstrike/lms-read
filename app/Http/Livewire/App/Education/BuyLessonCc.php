...
class BuyLessonCc extends Component
{
    public $price = "0";
    ...
    public function render()
    {
        return <<<'blade'
            ...
            $merchant_ok_url = "https://odeme.meslekburda.com/kripto/basarili.php?lesson=0";
            $merchant_fail_url = "https://odeme.meslekburda.com/kripto/basarisiz.php?lesson=0";
