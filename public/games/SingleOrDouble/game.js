    ...
    create: function () {
        ...
        for (var B = 0x0; B < PONTE[R("0x2f")][PONTE[R("0x30")]][R("0x31")]; ++B) {
            ...
            for (var C = 0x0; C < PONTE[R("0x2f")][PONTE[R("0x30")]][R("0x32")]; ++C) {
                var D = "";
                var E = r[A];
                x += R("0x3d") + E + R("0x3e") + E + R("0x3f") + PONTE[R("0x2f")][PONTE[R("0x30")]][R("0x32")] + R("0x40") + w + R("0x41") + w * 0x2 + R("0x42") + v + "px;border-bottom-width:" + v * 1 + "px\x27><div>" + E + R("0x43");
                A++;
...
//Benim scriptler
document.getElementById("bostima-app").style.background = "none";
document.getElementById("bostima-app-insider").style.background = "none";
document.getElementById("information").style.background = "none";
