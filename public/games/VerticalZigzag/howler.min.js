                ...
                a &&
                    ...
                    a._node &&
                        (o._webAudio
                            ...
                            : (isNaN(a._node.duration) && a._node.duration !== 1 / 0) || ((a._node.currentTime = a._start || 0), a._node.pause())),
    ...
    (HowlerGlobal.prototype._pos = [0, 0, 0]),
        ...
        (HowlerGlobal.prototype.pos = function (n, e, t) {
            ...
            return o.ctx && o.ctx.listener
                ? ((e = "number" != typeof e ? o._pos[1] : e), (t = "number" != typeof t ? o._pos[2] : t), "number" != typeof n ? o._pos : ((o._pos = [n, e, t]), o.ctx.listener.setPosition(o._pos[0], o._pos[1], o._pos[2]), o))
                : o;
        }),
        (HowlerGlobal.prototype.orientation = function (n, e, t, o, r, a) {
            ...
            return (
                ...
                "number" != typeof n ? p : ((i._orientation = [n, e, t, o, r, a]), i.ctx.listener.setOrientation(n, e, t, o, r, a), i)
            );
        }),
        ...
        (Howl.prototype.stereo = function (e, t) {
            ...
            for (var a = o._getSoundIds(t), i = 0; i < a.length; i++) {
                ...
                if (p) {
                    ...
                    (p._stereo = e),
                        (p._pos = [e, 0, 0]),
                        p._node && ((p._pannerAttr.panningModel = "equalpower"), (p._panner && p._panner.pan) || n(p, r), "spatial" === r ? p._panner.setPosition(e, 0, 0) : p._panner.pan.setValueAtTime(e, Howler.ctx.currentTime)),
        ...
        (Howl.prototype.orientation = function (e, t, o, r) {
            ...
            for (var i = a._getSoundIds(r), p = 0; p < i.length; p++) {
                ...
                if (s) {
                    ...
                    (s._orientation = [e, t, o]), s._node && (s._panner || (s._pos || (s._pos = a._pos || [0, 0, -0.5]), n(s, "spatial")), s._panner.setOrientation(e, t, o)), a._emit("orientation", s._id);
                }
            }
            return a;
        }),
        ...
        (e = e || "spatial"),
            "spatial" === e
                ? ((n._panner = Howler.ctx.createPanner()),
                  ...
                  n._panner.setOrientation(n._orientation[0], n._orientation[1], n._orientation[2]))
                : ((n._panner = Howler.ctx.createStereoPanner()), n._panner.pan.setValueAtTime(n._stereo, Howler.ctx.currentTime)),
